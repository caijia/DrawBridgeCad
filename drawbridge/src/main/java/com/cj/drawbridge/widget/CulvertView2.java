 ...
 */
public class CulvertView2 extends BaseBridgeView {

    private BridgeComponent16 bridgeComponent16;
    private BridgeParams params;

    public CulvertView2(Context context) {
        this(context, null);
    }

    public CulvertView2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CulvertView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
