 ...
 */
public class BridgeView18 extends BaseBridgeView {

    private BridgeComponent11 bridgeComponent11;
    private BridgeParams params;

    public BridgeView18(Context context) {
        this(context, null);
    }

    public BridgeView18(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BridgeView18(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        bridgeComponent11 = new BridgeComponent11(context, 90);
